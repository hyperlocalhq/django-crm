...
# Build ansible command - using django-crm-staging inventory and django_crm_deploy playbook
ANSIBLE_CMD="ansible-playbook -i inventories/django-crm-$ENVIRONMENT/hosts.yml django_crm_deploy.yml"
